<?php
			...
			echo 'Full Name : ' . $this->session->userdata('name');
			echo "<br>";
			echo "Email : " . $this->session->userdata('email');
			echo "<br>";
			
			echo form_open('main/facebook_beautician_signup');
			...
			echo form_label('JobSet : ', 'jobset[]');
			echo form_multiselect('jobset[]', $options);
